...
const dbUrl = process.env.ATLAS_URL || 'mongodb://127.0.0.1:27017/wonderlust';const app = express();
...
const sessionOptions = {
    secret: process.env.SECRET, // Use your own secret or fallback to a default value
    resave: false,
